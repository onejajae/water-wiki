<script>
  ...
  const infoWindowContent = [
    `<div class="m-3">`,
    `<a href="https://map.naver.com/v5/search?c=${supplierPositionEPSG3857.x},${supplierPositionEPSG3857.y},18,0,0,2,dh" class="link-offset-2 link-underline link-underline-opacity-0" target="_blank" rel="noopener noreferrer">`,
